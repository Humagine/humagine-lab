namespace Common.Messaging.UnitTests.Dispatching
{
	...
	public class when_publishing_a_message_for_a_projection_handler : using_a_common_bus_as_a_bus
	{
		...
		private Establish context =
			() =>
				{
					windsorContainer.Register(Component.For<IProjectionHandler<TestData>>().ImplementedBy<TestHandler>());
		...
		private class TestHandler : IProjectionHandler<TestData>
		{
